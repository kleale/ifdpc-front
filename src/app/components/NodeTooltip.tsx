...
import { Background, NodeToolbar, type NodeToolbarProps } from "@xyflow/react";
...
export function NodeTooltipContent({
  ...
  return (
    <div >
      <NodeToolbar
        isVisible={isVisible}
        style={{backgroundColor:'fff', fontSize: '9px'}}
        className=
          "tooltip bg-primary text-primary-foreground rounded-sm p-2"
        tabIndex={1}
        position={position}
        {...props}
      >
