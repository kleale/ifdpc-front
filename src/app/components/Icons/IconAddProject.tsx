...
const IconAddProjectD = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width="20"
    height="20"
    viewBox="0 0 20 20"
...
export const IconAddProject = createIcon({
  l: IconAddProjectD,
  m: IconAddProjectD,
  s: IconAddProjectD,
  xs: IconAddProjectD,
